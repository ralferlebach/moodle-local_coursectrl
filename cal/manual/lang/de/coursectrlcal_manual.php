...
$string['pluginname']       = 'Kursablauf-Zentrale: Manuelle Feiertage';
$string['privacy:metadata'] = 'Der manuelle Kalender-Adapter speichert keine personenbezogenen Daten.';
$string['setting_enabled']       = 'Manuelle Feiertags-Eingabe aktivieren';
$string['setting_entries']       = 'Feiertags-Einträge';

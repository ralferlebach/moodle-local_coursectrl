...
/**
 * German strings for coursectrlcal_openholidays.
 *
...
$string['setting_countryisocode_desc']  = 'Z.B. DE, AT, CH';
$string['setting_enabled']              = 'OpenHolidays-API-Anbieter aktivieren';
$string['setting_languageisocode']      = 'Sprach-ISO-Code';

...
/**
 * Event fired when a new report is generated and stored.
 */
class report_generated extends \core\event\base {
    /**
    ...
    protected function init(): void {
        ...
        $this->data['objecttable'] = 'local_coursectrl_report';
    }
    ...
    public static function get_name(): string {
        return get_string('event_report_generated', 'local_coursectrl');
    }
    ...
    public function get_description(): string {
        $reporttype = $this->other['reporttype'] ?? 'unknown';
        return "User {$this->userid} generated a '{$reporttype}' report (id {$this->objectid})"

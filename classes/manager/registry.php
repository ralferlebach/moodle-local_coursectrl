...
class registry
{
    ...
    /** @var null|string[] Optional override for discovery, used by tests. */
    private ?array $classnameoverride;

    /**
     * Constructor.
     *
     * @param null|string[] $classnameoverride Optional list of fully qualified
    ...
    {
        return null !== $this->get_for_component($component);
    }

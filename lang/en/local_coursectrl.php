...
$string['consistency_detail_temporal_conflict']   = '"{$a->field_early}" ({$a->date_early}) is set later than "{$a->field_late}" ({$a->date_late}). The order of these dates is incorrect.';
...
$string['consistency_consequence_r0_deadline_past'] = 'Once the deadline has passed, learners can no longer submit or complete the activity on time. If this activity is part of the completion path, it will block course completion for all learners who have not yet finished it.';
...
$string['risk_problem_temporal_conflict']              = 'In "{$a->cmname}": "{$a->field_early}" ({$a->date_early}) is set after "{$a->field_late}" ({$a->date_late}). The order of these dates is incorrect.';
...
$string['field_availability_from']   = 'Available from (condition)';
$string['field_availability_until']  = 'Available until (condition)';

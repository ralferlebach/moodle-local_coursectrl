...
$string['history_already_rolled_back']         = 'rolled back';
$string['history_batches']                     = 'Executed batches';
$string['history_col_action']                  = 'Action';
$string['history_col_date']                    = 'Date';
$string['history_col_items']                   = 'Items';
$string['history_col_status']                  = 'Status';
$string['history_empty']                       = 'No batch actions have been executed in this course yet.';
$string['history_items_failed']                = 'items failed';
$string['history_rollback_btn']                = 'Roll back';
$string['history_rollback_confirm']            = 'Roll back all changes in this batch? This cannot be undone.';
$string['history_rollback_detail']             = 'Rollback detail';
$string['history_rollback_error']              = 'Rollback failed';
$string['history_rollback_success']            = '{$a->restored} item(s) restored successfully.';
$string['history_title']                       = 'Batch History';
...
$string['sim_blocked']                         = 'Blocked activities';

...
$string['settings_calmoodlecal_eventtype']        = 'Event types to include';
$string['settings_calmoodlecal_eventtype_desc']   = 'Comma-separated: site, category, user. Default: site. Avoid course (creates circular references with activity deadlines).';
...
$string['settings_calmanual_desc']                = 'Enter custom free days (company holidays, events, etc.) directly.';
$string['settings_calmanual_enabled']             = 'Enable manual free-day provider';
$string['settings_calmanual_entries']             = 'Free day entries';
...
$string['settings_calmanual_heading']             = 'Manual Free Days';

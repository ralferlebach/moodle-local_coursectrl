...
$string['warning_dangling_group']              = 'Availability requires a non-existent group (ID {$a->groupid})';
$string['warning_dangling_grouping']           = 'Availability requires a non-existent grouping (ID {$a->groupingid})';

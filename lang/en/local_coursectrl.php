...
$string['risks_run_now']                             = 'Run assessment now';
$string['risks_last_run']                            = 'Last assessment';
$string['risks_no_issues']                           = 'No issues found. The course structure is consistent.';
$string['risks_not_run_yet']                         = 'The risk assessment has not yet been run for this course.';
$string['risks_badge_error']                         = 'Errors';
$string['risks_badge_warning']                       = 'Warnings';
$string['risks_badge_notice']                        = 'Notices';
$string['risks_score']                               = 'Priority';
$string['risks_affected']                            = 'Affected activities';
$string['risks_cascade']                             = 'also unblocks {$a} further activity/activities';
$string['risks_score_detail']                        = 'Priority score (0–100)';
$string['risks_escape_break_cycle']                  = 'Fix: remove a dependency to break the cycle';
$string['risks_escape_unhide_cm']                    = 'Fix: make the activity visible';
$string['risks_escape_enable_completion']            = 'Fix: enable completion tracking on the prerequisite';
$string['risks_escape_fix_dates']                    = 'Fix: correct the date configuration';
$string['risks_escape_none']                         = 'No automated fix path identified';
...
$string['settings_risk_maxdepth_desc']               = 'Maximum recursion depth for detecting transitive cycles. 0 = unlimited (not recommended for very large courses). Default: 10.';

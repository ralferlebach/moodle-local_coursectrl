...
$string['check_assign_allowsubmissionsfromdate_without_duedate'] = 'Submission window is open but no due date is set.';
$string['check_assign_cutoffdate_without_duedate']               = 'Cut-off date is set but no due date is specified.';
$string['check_assign_gradingduedate_without_duedate']           = 'Grading due date is set but neither due date nor cut-off date is specified.';
$string['check_choice_open_after_close']                         = 'Opening time is after closing time (invalid combination).';
$string['check_choicegroup_open_after_close']                    = 'Opening time is after closing time (invalid combination).';
$string['check_feedback_open_after_close']                       = 'Opening time is after closing time (invalid combination).';
$string['check_forum_assesstimefinish_after_duedate']            = 'Rating window end is after the post due date.';
$string['check_forum_assesstimefinish_without_assesstimestart']  = 'Rating window end is set but no start is specified (required when feature is active).';
$string['check_forum_assesstimestart_after_assesstimefinish']    = 'Rating window start is after its end (invalid combination).';
$string['check_forum_assesstimestart_without_assesstimefinish']  = 'Rating window start is set but no end is specified (required when feature is active).';
$string['check_forum_cutoffdate_without_duedate']                = 'Cut-off date is set but no due date is specified.';
$string['check_forum_duedate_without_cutoffdate']                = 'Due date is set but no cut-off date is specified.';
$string['check_glossary_assess_start_after_finish']              = 'Assessment start time is after assessment end time (invalid combination).';
$string['check_glossary_assesstimefinish_without_start']         = 'Rating window end is set but no start is specified (required when feature is active).';
$string['check_glossary_assesstimestart_without_finish']         = 'Rating window start is set but no end is specified (required when feature is active).';
$string['check_lesson_available_after_deadline']                 = 'Opening date is after the deadline (invalid combination).';
$string['check_lesson_available_without_deadline']               = 'Opening date is set but no deadline is specified.';
$string['check_questionnaire_open_after_close']                  = 'Opening date is after the closing date (invalid combination).';
$string['check_quiz_open_after_close']                           = 'Opening time is after closing time (invalid combination).';
$string['check_quiz_timelimit_exceeds_window']                   = 'Time limit exceeds the available window between open and close time.';
$string['check_quiz_timeopen_without_timeclose']                 = 'Opening time is set but no closing time is specified.';
$string['check_scorm_open_after_close']                          = 'Opening time is after closing time (invalid combination).';
$string['check_studentquiz_answeringopen_after_close']           = 'Answering phase: opening time is after closing time (invalid combination).';
$string['check_studentquiz_submissionclose_after_answeringopen'] = 'Submission phase closes after the answering phase opens (invalid combination).';
$string['check_studentquiz_submissionopen_after_close']          = 'Submission phase: opening time is after closing time (invalid combination).';
$string['check_workshop_assessment_without_submissionend']       = 'Assessment phase is defined but no submission end date is set.';
$string['check_workshop_assessmentend_without_assessmentstart']  = 'Assessment phase end is set but no start is specified.';
$string['check_workshop_assessmentstart_after_assessmentend']    = 'Assessment phase: start is after end (invalid combination).';
$string['check_workshop_assessmentstart_without_assessmentend']  = 'Assessment phase start is set but no end is specified.';
$string['check_workshop_submissionend_after_assessmentstart']    = 'Submission phase ends after the assessment phase starts (invalid combination).';
$string['check_workshop_submissionstart_after_submissionend']    = 'Submission phase: start is after end (invalid combination).';
$string['dashboard_notice_detail_title']                         = 'Notice(s)';
$string['notice_completionexpected_early']                       = 'Expected completion is more than one week before the deadline ({$a->field}).';
$string['warning_completionexpected_after_deadline']             = 'Expected completion is set after the deadline ({$a->field}).';
$string['warning_dangling_group']                                = 'Availability condition references a non-existent group (ID {$a->groupid}).';
$string['warning_dangling_grouping']                             = 'Availability condition references a non-existent grouping (ID {$a->groupingid}).';

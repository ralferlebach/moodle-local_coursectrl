...
/**
 * Field descriptor map for the mod_choice adapter.
 *
 * A stored value of 0 means "unset" for both fields and must not be
 * shifted (nullable_zero = true).
 *
...
/**
 * Static field descriptor source for mod_choice.
 */

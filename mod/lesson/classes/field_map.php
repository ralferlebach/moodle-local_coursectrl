...
/**
 * Field descriptor map for the lesson adapter.
 *
...
/**
 * Static field descriptor source for mod_lesson.
 */
final class field_map {
    ...
    public static function get_date_fields(): array {
        return [
            'available' => [
                'name'          => 'available',
                'label_key'     => 'field_available',
                'sql_column'    => 'available',
                'shiftable'     => true,
                'nullable_zero' => true,
            ],
            'deadline' => [
                'name'          => 'deadline',
                'label_key'     => 'field_deadline',
                'sql_column'    => 'deadline',
                'shiftable'     => true,
                'nullable_zero' => true,
            ],

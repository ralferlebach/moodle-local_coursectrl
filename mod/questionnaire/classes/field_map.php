...
/**
 * Field descriptor map for the questionnaire adapter.
 *
...
/**
 * Static field descriptor source for mod_questionnaire.
 */
final class field_map {
    ...
    public static function get_date_fields(): array {
        return [
            ...
            'closedate' => [
                'name'          => 'closedate',
                'label_key'     => 'field_closedate',
                'sql_column'    => 'closedate',
                'shiftable'     => true,
                'nullable_zero' => true,
            ],
        ];

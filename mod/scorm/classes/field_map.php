...
/**
 * Field descriptor map for the mod_scorm adapter.
 *
 * timeopen and timeclose control the access window for the SCORM package.
...
/**
 * Static field descriptor source for mod_scorm.
 */

...
class behat_local_coursectrl extends behat_base {
     ...
     *
     * @Then /^the duedate of assign "?(?P<name>[^"]+?)"? in course "?(?P<shortname>[^"]+?)"? should be shifted by (?P<days>-?\d+) day\(s\) from (?P<originalts>-?\d+)$/
     ...
     *
     * @Then /^the completionexpected of (?P<modtype>\w+) "?(?P<name>[^"]+?)"? in course "?(?P<shortname>[^"]+?)"? should be shifted by (?P<days>-?\d+) day\(s\) from (?P<originalts>-?\d+)$/
     ...
     *
     * @Then /^the timeopen of quiz "?(?P<name>[^"]+?)"? in course "?(?P<shortname>[^"]+?)"? should be shifted by (?P<days>-?\d+) day\(s\) from (?P<originalts>-?\d+)$/
     ...
     *
     * @Then /^the timeclose of quiz "?(?P<name>[^"]+?)"? in course "?(?P<shortname>[^"]+?)"? should be shifted by (?P<days>-?\d+) day\(s\) from (?P<originalts>-?\d+)$/
     * @param string $name       Quiz instance name.
     * @param string $shortname  Course shortname.
     * @param int    $days       Number of days shifted.
     * @param int    $originalts Original Unix timestamp.
